...
var pageEarUrl = "pageear/laufladen/"

// URL zum kleinen Bild / URL to small image 
var pagearSmallImg = pageEarUrl+ 'image_small.jpg'; 
// URL zu pageear_s.swf / URL to small pageear swf
var pagearSmallSwf = pageEarUrl + 'pageear_s.swf'; 

// URL zum großen Bild / URL to big image
var pagearBigImg = pageEarUrl + 'image_large.jpg'; 
// URL zu pageear_b.swf / URL to big pageear swf
var pagearBigSwf = pageEarUrl + 'pageear_b.swf'; 
...
var jumpTo = 'pageear/laufladen/FlyerLaufladenEnspurtSonderangebot.jpg' 
...
function openPeel(){
	document.getElementById('bigDiv').style.top = '3px'; 
	document.getElementById('bigDiv').style[xPos] = '4px';
	document.getElementById('thumbDiv').style.top = '-1000px';
}

function closePeel(){
	document.getElementById("thumbDiv").style.top = "3px";
...
function writeObjects () { 
    ...
    document.write('<div id="thumbDiv" style="position:absolute;width:'+ thumbWidth +'px;height:'+ thumbHeight +'px;z-index:9999;'+xPos+':6px;top:3px;">');
